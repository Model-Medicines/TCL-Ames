...
def run_all_datasets(base_dir='./Ready_Data', output_base='./All_Results'):
    """
    ...
    for i, (train_path, test_path, dataset_name) in enumerate(dataset_pairs, 1):
        ...
        output_dir = os.path.join(output_base, f'results_{dataset_name}')
...
def run_single_dataset(dataset_name, base_dir='./Ready_Data', output_base='./All_Results'):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default='./All_Results',
        help='Base path for output directories (default: ./All_Results)'
    )
