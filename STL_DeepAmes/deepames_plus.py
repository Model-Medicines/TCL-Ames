...
def dim_reduce(df, test_df, model_path, col_name1, weight):
...
def deepames_prediction(probability_path, name, weight, result_path, model_output_dir=None):
    ###data
    ...
    ###get the prediction
    validation_class, validation_result, test_class, test_result = dim_reduce(data, test, model_path, col_name, weight)
